$(function () {
  ...
  $('.movie-button').on('click', function () {
    var my_api_key = 'a9152dc449acf6e88928fc6bf1c27a58';
    var title = $('.movie').val();
    if (title == "") {
...
function load_details(my_api_key, title) {
  // var my_api_key = 'a9152dc449acf6e88928fc6bf1c27a58'; //new
  $.ajax({
    type: 'GET',
...
function get_movie_details(movie_id, my_api_key, arr, movie_title) {
  ...
  $.ajax({
    type: 'GET',
    // https://api.themoviedb.org/3/movie/550?api_key=a9152dc449acf6e88928fc6bf1c27a58
